...
namespace meteor
{
    namespace msumr
    {
        namespace lrpt
        {
            ...
            meteorimg::SimpleImage MSUMRReader::getChannel(int channel, size_t max_correct)
            {
                ...
                meteorimg::SimpleImage ret(8, 1568, lines[channel], 1);
                ...
                for (uint32_t x = firstSeg_line; x < lastSeg_line; x += 14)
                {
                    ...
                    timestamps.push_back(meteorimg::most_common(line_timestamps.begin(), line_timestamps.end(), -1.0));
                }
