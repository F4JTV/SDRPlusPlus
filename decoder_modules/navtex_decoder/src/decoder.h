...
// rtty_decoder / psk_decoder / mfsk_decoder modules so the module UI (band
// view, AFC, AF slider, squelch, sideband) stays identical across decoders.
...
public:
    ...
    virtual void  setMode(int modeIdx) = 0;      // NAVTEX preset index
