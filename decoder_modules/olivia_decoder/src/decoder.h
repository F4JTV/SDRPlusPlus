...
// Base interface for the Olivia decoder, mirroring the control surface of the
// mfsk_decoder / psk_decoder modules (VFO sideband, AF cursor, mode, squelch,
// start/stop) plus the Olivia-specific sync parameters.
...
namespace olivia {
    ...
    static constexpr float OLIVIA_SQUELCH_MIN = -100.0f;
    static constexpr float OLIVIA_SQUELCH_MAX = 0.0f;
    ...
    public:
        ...
        virtual void setMode(int modeIdx) = 0;       // index into OLIVIA_MODES
