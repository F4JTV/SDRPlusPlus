// olivia_gen.cpp -- standalone Olivia test-signal generator.
//
// Encodes ASCII text into an Olivia audio WAV (8 kHz, mono, 16-bit) using the
...
//
// Examples:
//   ./olivia_gen --mode 16-500 "CQ CQ DE TEST 73"          -> olivia_16-500.wav
//   ./olivia_gen --mode 8-250 --snr 0 --center 1200 "..."  -> noisy 0 dB signal
//   ./olivia_gen --mode 32-1000 --out test.wav "hello"
//
...
//   --out    file  output WAV path (default olivia_<mode>.wav)
...
int main(int argc, char** argv) {
    ...
    if (text.empty()) text = "CQ CQ DE TEST OLIVIA 73";
    if (out.empty()) out = "olivia_" + modeStr + ".wav";
