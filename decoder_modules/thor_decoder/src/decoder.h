...
// Base interface for the THOR decoder, mirroring the control surface of the
...
namespace thor {
    ...
    static constexpr float THOR_SQUELCH_MIN = -100.0f;
    static constexpr float THOR_SQUELCH_MAX = 0.0f;
    ...
    public:
        ...
        virtual void setMode(int modeIdx) = 0;       // index into THOR_MODES
